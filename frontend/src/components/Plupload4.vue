<template>
  <div>
    <div id="ossfile4">你的浏览器不支持flash,Silverlight或者HTML5！</div>
    <el-button id="selectfiles4" size="mini">选择图片</el-button>
    <el-button size="small" type="primary" id="postfiles4">点击上传</el-button>
    <el-upload
      :file-list="fileList"
      list-type="picture"
      id="uploadContainer4">
        ...
        methods: {
            initPlUploader() {
                ...
                const uploader = new plupload.Uploader({
                    ...
                    container: document.getElementById("uploadContainer4"),
                    ...
                    init: {
                        PostInit() {
                            ...
                            document.getElementById("ossfile4").innerHTML = "";
                        ...
                        FileUploaded(up, file, info) {
                            ...
                            that.$emit("fun", that.g_object_name, 5);
                        },
