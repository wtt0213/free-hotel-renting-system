<template>
  <div>
    ...
    <el-button id="selectfiles2" size="mini">选择图片</el-button>
    <el-button size="small" type="primary" id="postfiles2">点击上传</el-button>
    <el-upload
      :file-list="fileList"
      list-type="picture" id="uploadContainer2">
    </el-upload>
        ...
        methods: {
            initPlUploader() {
                ...
                const uploader = new plupload.Uploader({
                    ...
                    container: document.getElementById("uploadContainer2"),
                    ...
                    init: {
                        ...
                        FileUploaded(up, file, info) {
                            ...
                            that.$emit("fun", that.g_object_name, 3);
                        },
